...
struct UBakeMeshAttributeMapsToolProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetUVLayerNamesFunc(); // Function MeshModelingTools.BakeMeshAttributeMapsToolProperties.GetUVLayerNamesFunc // (Final|Native|Public) // @ game+0x1457300
};
...
struct UDisplaceMeshCommonProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetWeightMapsFunc(); // Function MeshModelingTools.DisplaceMeshCommonProperties.GetWeightMapsFunc // (Final|Native|Public) // @ game+0x1457300
};
...
struct UEditMeshPolygonsToolActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Retriangulate(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Retriangulate // (Final|Native|Public) // @ game+0x1460680
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions.RecalcNormals // (Final|Native|Public) // @ game+0x1460660
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Outset // (Final|Native|Public) // @ game+0x1460600
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Offset // (Final|Native|Public) // @ game+0x14605e0
	void Merge(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Merge // (Final|Native|Public) // @ game+0x14605c0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Inset // (Final|Native|Public) // @ game+0x1460580
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Flip // (Final|Native|Public) // @ game+0x1460520
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Extrude // (Final|Native|Public) // @ game+0x14604e0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Disconnect // (Final|Native|Public) // @ game+0x14604c0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Delete // (Final|Native|Public) // @ game+0x14604a0
	void Decompose(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Decompose // (Final|Native|Public) // @ game+0x1460480
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions.CutFaces // (Final|Native|Public) // @ game+0x1460460
};
...
struct UEditMeshPolygonsToolActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.RecalcNormals // (Final|Native|Public) // @ game+0x1460660
	void Poke(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Poke // (Final|Native|Public) // @ game+0x1460640
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Outset // (Final|Native|Public) // @ game+0x1460600
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Offset // (Final|Native|Public) // @ game+0x14605e0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Inset // (Final|Native|Public) // @ game+0x1460580
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Flip // (Final|Native|Public) // @ game+0x1460520
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Extrude // (Final|Native|Public) // @ game+0x14604e0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Disconnect // (Final|Native|Public) // @ game+0x14604c0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Delete // (Final|Native|Public) // @ game+0x14604a0
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.CutFaces // (Final|Native|Public) // @ game+0x1460460
};
...
struct UEditMeshPolygonsToolUVActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void PlanarProjection(); // Function MeshModelingTools.EditMeshPolygonsToolUVActions.PlanarProjection // (Final|Native|Public) // @ game+0x1460620
};
...
struct UEditMeshPolygonsToolEdgeActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Weld // (Final|Native|Public) // @ game+0x1460740
	void Straighten(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Straighten // (Final|Native|Public) // @ game+0x1460700
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.FillHole // (Final|Native|Public) // @ game+0x1460500
};
...
struct UEditMeshPolygonsToolEdgeActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Weld // (Final|Native|Public) // @ game+0x1460740
	void Split(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Split // (Final|Native|Public) // @ game+0x14606e0
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Flip // (Final|Native|Public) // @ game+0x1460540
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.FillHole // (Final|Native|Public) // @ game+0x1460500
	void Collapse(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Collapse // (Final|Native|Public) // @ game+0x1460440
};
...
struct UEditPivotToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Top(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Top // (Final|Native|Public) // @ game+0x1460720
	void Right(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Right // (Final|Native|Public) // @ game+0x14606a0
	void Left(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Left // (Final|Native|Public) // @ game+0x14605a0
	void Front(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Front // (Final|Native|Public) // @ game+0x1460560
	void Center(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Center // (Final|Native|Public) // @ game+0x1460400
	void Bottom(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Bottom // (Final|Native|Public) // @ game+0x14603e0
	void Back(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Back // (Final|Native|Public) // @ game+0x14603c0
};
...
struct UHoleFillToolActions : UInteractiveToolPropertySet {
	...
	void SelectAll(); // Function MeshModelingTools.HoleFillToolActions.SelectAll // (Final|Native|Public) // @ game+0x14606c0
	void Clear(); // Function MeshModelingTools.HoleFillToolActions.Clear // (Final|Native|Public) // @ game+0x1460420
};
...
struct UMeshSelectionEditActions : UMeshSelectionToolActionPropertySet {
	...
	void Shrink(); // Function MeshModelingTools.MeshSelectionEditActions.Shrink // (Final|Native|Public) // @ game+0x1465870
	void SelectLargestComponentByTriCount(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByTriCount // (Final|Native|Public) // @ game+0x1465830
	void SelectLargestComponentByArea(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByArea // (Final|Native|Public) // @ game+0x1465810
	void SelectAll(); // Function MeshModelingTools.MeshSelectionEditActions.SelectAll // (Final|Native|Public) // @ game+0x14657f0
	void OptimizeSelection(); // Function MeshModelingTools.MeshSelectionEditActions.OptimizeSelection // (Final|Native|Public) // @ game+0x14657d0
	void Invert(); // Function MeshModelingTools.MeshSelectionEditActions.Invert // (Final|Native|Public) // @ game+0x14657b0
	void Grow(); // Function MeshModelingTools.MeshSelectionEditActions.Grow // (Final|Native|Public) // @ game+0x1465790
	void ExpandToConnected(); // Function MeshModelingTools.MeshSelectionEditActions.ExpandToConnected // (Final|Native|Public) // @ game+0x1465750
	void Clear(); // Function MeshModelingTools.MeshSelectionEditActions.Clear // (Final|Native|Public) // @ game+0x14656d0
};
...
struct UMeshSelectionMeshEditActions : UMeshSelectionToolActionPropertySet {
	...
	void SeparateTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.SeparateTriangles // (Final|Native|Public) // @ game+0x1465850
	void FlipNormals(); // Function MeshModelingTools.MeshSelectionMeshEditActions.FlipNormals // (Final|Native|Public) // @ game+0x1465770
	void DisconnectTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DisconnectTriangles // (Final|Native|Public) // @ game+0x1465730
	void DeleteTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DeleteTriangles // (Final|Native|Public) // @ game+0x1465710
	void CreatePolygroup(); // Function MeshModelingTools.MeshSelectionMeshEditActions.CreatePolygroup // (Final|Native|Public) // @ game+0x14656f0
};
...
struct UMirrorToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Up(); // Function MeshModelingTools.MirrorToolActionPropertySet.Up // (Final|Native|Public) // @ game+0x146a640
	void ShiftToCenter(); // Function MeshModelingTools.MirrorToolActionPropertySet.ShiftToCenter // (Final|Native|Public) // @ game+0x146a620
	void Right(); // Function MeshModelingTools.MirrorToolActionPropertySet.Right // (Final|Native|Public) // @ game+0x146a600
	void Left(); // Function MeshModelingTools.MirrorToolActionPropertySet.Left // (Final|Native|Public) // @ game+0x146a5e0
	void Forward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Forward // (Final|Native|Public) // @ game+0x146a5c0
	void Down(); // Function MeshModelingTools.MirrorToolActionPropertySet.Down // (Final|Native|Public) // @ game+0x146a5a0
	void Backward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Backward // (Final|Native|Public) // @ game+0x146a560
};
...
struct UPlaneCutTool : UMultiSelectionTool {
	...
	void Cut(); // Function MeshModelingTools.PlaneCutTool.Cut // (Final|Native|Protected) // @ game+0x146a580
};
