...
struct AHDRIBackdrop_C : AActor {
	...
	void CreateMaterial(); // Function HDRIBackdrop.HDRIBackdrop_C.CreateMaterial // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1ec38f0
	void UserConstructionScript(); // Function HDRIBackdrop.HDRIBackdrop_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1ec38f0
};
